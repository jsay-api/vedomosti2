      ...
      {% block header %}
        {% if not is_popup %}
          ...
          <div id="header" class="header">
            ...
            {% endblock %}
            <a href="/"><img src={% static "img/home.png" %} alt="home" class="menu"> На основной сайт</a>
            </span>
...
{% block footer %}
  ...
  <div id="footer" class="footer">
    <div class="content">
      ...
      <div class="copyright">
        {% block copyright %}
          Copyright &copy; 2016 Ведомости<br>Developed by <a href="https://il.linkedin.com/in/julia-sayapina-006b7868" target="_blank">Julia Sayapina</a>
        {% endblock %}
      </div>
