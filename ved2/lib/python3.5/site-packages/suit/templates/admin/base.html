...
<head>
  ...
  <title>ВЕДОМОСТИ | {% block title %}{{ title }}{% endblock %}</title>
      ...
      {% block header %}
        {% if not is_popup %}
          ...
          <div id="header" class="header">
              ...
              <!-- <a href="{% url 'admin:index' %}"><img src={% static "img/logo.png" %}></a> -->
            ...
            {% block header_time %}
              ...
              <span class="navi">
              {% block menu %}
                {% include 'inc-menu-admin.html' %} 
              {% endblock %}
              <a href="/"><img src={% static "img/home.png" %} alt="home" class="menu home"> На основной сайт</a>
              </span>

              <a href="{% url 'admin:index' %}" ><img src={% static "img/logo.png" %} alt="logo" class="logo"></a>
            ...
            {% endblock %}
            <!-- <a href="{% url 'admin:index' %}" class="logo"><img src={% static "img/logo.png" %} alt="logo"></a> -->
            {% if user.is_active and user.is_staff %}
              <div id="user-tools">
                ...
                {% block userlinks %}
                  ...
                  {% endif %}
                  <a href="{% url 'admin:password_change' %}"><img src={% static "img/pass.png" %}>{% trans 'Change password' %}</a>
                  <span class="separator">|</span>
                  <a href="{% url 'admin:logout' %}"><img src={% static "img/logout.png" %}>{% trans 'Log out' %}</a>
                {% endblock %}
                </span>
              </div>
            {% endif %}
...
{% block footer %}
  ...
  <div id="footer" class="footer">
    <div class="content">
      ...
      <div class="copyright">
        {% block copyright %}
          &copy; 2016 <a href="http://www.vedomosti.ru/"> Ведомости</a><br>Developed by <a href="https://il.linkedin.com/in/julia-sayapina-006b7868" target="_blank">Julia Sayapina</a>
        {% endblock %}
      </div>
